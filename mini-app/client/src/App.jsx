        ...
        <>
          <section className="card">
            ...
            <ol className="instructions">
              <li>Установите V2R или другой V2Ray-совместимый клиент на телефон или компьютер.</li>
              <li>В разделе «Главная» нажмите «Создать профиль».</li>
              <li>Нажмите «Открыть в клиенте» или «Скопировать ссылку».</li>
              <li>Импортируйте ссылку в V2R и включите подключение.</li>
            </ol>
            <p className="muted">Если ссылка не открылась автоматически, скопируйте её вручную и вставьте в V2R.</p>
          </section>
        </>
      )}
